...
config.General.requestName = 'ST_tW_DR_14TeV_antitop_incl_noPUsplitfix'
...
#noPU
config.Data.inputDataset = '/ST_tW_DR_14TeV_antitop_incl-powheg-pythia8/PhaseIITDRFall17MiniAOD-noPU_93X_upgrade2023_realistic_v2-v1/MINIAODSIM'
#PU
