...
config.General.requestName = 'VBF_HToInvisible_M125_PU200splitfixMoreRAMv1whitelist'
...
config.Site.whitelist = ['T2_US_Wisconsin','T2_IT_Pisa','T2_FR_GRIF_IRFU','T2_US_Vanderbilt']
