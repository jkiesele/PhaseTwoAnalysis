...
#config.General.requestName = 'VBFHToInvisiblenoPUsplit'
config.General.requestName = 'VBFHToInvisible200PUsplitbis'
...
config.Site.blacklist = ['T2_ES_CIEMAT','T2_UK_London_IC','T2_US_Nebraska']
