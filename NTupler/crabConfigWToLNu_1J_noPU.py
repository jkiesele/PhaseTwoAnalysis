...
config.General.requestName = 'WToLNu_1J_noPUsplitfix'
...
#noPU
config.Data.inputDataset = '/WToLNu_1J_14TeV-madgraphMLM-pythia8/PhaseIITDRFall17MiniAOD-noPU_93X_upgrade2023_realistic_v2-v1/MINIAODSIM'
#PU
