...
config.General.requestName = 'EWKZ2Jets_ZToNuNu_noPUsplitfix'
...
#noPU
config.Data.inputDataset = '/EWKZ2Jets_ZToNuNu_14TeV-madgraph-pythia8/PhaseIITDRFall17MiniAOD-noPU_93X_upgrade2023_realistic_v2-v1/MINIAODSIM'
#PU
