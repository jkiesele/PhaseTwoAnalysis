...
config.General.requestName = 'WToLNu_2J_noPUsplitfix'
...
#noPU
config.Data.inputDataset = '/WToLNu_2J_14TeV-madgraphMLM-pythia8/PhaseIITDRFall17MiniAOD-noPU_93X_upgrade2023_realistic_v2-v2/MINIAODSIM'
#PU
