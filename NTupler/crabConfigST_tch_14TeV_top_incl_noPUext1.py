...
config.General.requestName = 'ST_tch_14TeV_top_incl_noPUext1splitfix'
...
#noPU
config.Data.inputDataset = '/ST_tch_14TeV_top_incl-powheg-pythia8-madspin/PhaseIITDRFall17MiniAOD-noPU_93X_upgrade2023_realistic_v2_ext1-v1/MINIAODSIM'
#PU
